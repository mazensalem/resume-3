  ...
  return (
    <div ref={sectionref} id="esection" className="opacity-0 w-screen pt-10">
      ...
      <div className="text-lg w-3/5 mx-auto mt-10 flex flex-wrap">
        <div className="relative mr-3 mb-32 bg-black text-white dark:bg-white dark:text-black w-33 px-2 py-3">
          ...
          <div className="z-0 bottom-0 left-3 transform translate-y-2/4 rotate-45 absolute w-8 h-8 bg-black border-black dark:bg-white dark:border-white border-r-8 border-b-8"></div>
          <div className="absolute flex space-x-3 -bottom-7 transform translate-y-full">
            ...
            />
            <p className="w-max">
              <h2 className="text-xl text-primary dark:text-primarydark">
                Ben Johnson
              </h2>
              <span className="text-sm text-tertiary">CEO of Company Inc.</span>
            </p>
          </div>
        </div>
        <div className="relative mr-3 mb-32 bg-black text-white dark:bg-white dark:text-black w-33 px-2 py-3">
